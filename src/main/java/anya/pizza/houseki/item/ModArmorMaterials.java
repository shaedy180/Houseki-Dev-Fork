...
public class ModArmorMaterials {
    ...
    public static final RegistryKey<EquipmentAsset> METEORIC_IRON_KEY = RegistryKey.of(REGISTRY_KEY, Identifier.of(Houseki.MOD_ID, "meteoric_iron"));

    public static final ArmorMaterial PINKU_MATERIAL = new ArmorMaterial(47, Util.make(new EnumMap<>(EquipmentType.class), map -> {
    ...
    public static final ArmorMaterial RAINBOW_MATERIAL = new ArmorMaterial(16, Util.make(new EnumMap<>(EquipmentType.class), map -> {
    ...
    public static final ArmorMaterial TUNGSTEN_MATERIAL = new ArmorMaterial(38, Util.make(new EnumMap<>(EquipmentType.class), map -> {
    ...
    public static final ArmorMaterial ALUMINUM_MATERIAL = new ArmorMaterial(15, Util.make(new EnumMap<>(EquipmentType.class), map -> {
        map.put(EquipmentType.HELMET, 3);
        map.put(EquipmentType.CHESTPLATE, 8);
        map.put(EquipmentType.LEGGINGS, 6);
        map.put(EquipmentType.BOOTS, 3);
    ...
    public static final ArmorMaterial SAPPHIRE_MATERIAL = new ArmorMaterial(34, Util.make(new EnumMap<>(EquipmentType.class), map -> {
    ...
    public static final ArmorMaterial NEPHRITE_MATERIAL = new ArmorMaterial(33, Util.make(new EnumMap<>(EquipmentType.class), map -> {
        map.put(EquipmentType.HELMET, 3);
        map.put(EquipmentType.CHESTPLATE, 9);
        map.put(EquipmentType.LEGGINGS, 6);
        map.put(EquipmentType.BOOTS, 5);
    ...
    public static final ArmorMaterial JADEITE_MATERIAL = new ArmorMaterial(36, Util.make(new EnumMap<>(EquipmentType.class), map -> {
        map.put(EquipmentType.HELMET, 4);
        map.put(EquipmentType.CHESTPLATE, 10);
        map.put(EquipmentType.LEGGINGS, 7);
        map.put(EquipmentType.BOOTS, 6);
    ...
    public static final ArmorMaterial PLATINUM_MATERIAL = new ArmorMaterial(35, Util.make(new EnumMap<>(EquipmentType.class), map -> {
        map.put(EquipmentType.HELMET, 4);
        map.put(EquipmentType.CHESTPLATE, 9);
        map.put(EquipmentType.LEGGINGS, 7);
        map.put(EquipmentType.BOOTS, 4);
    ...
    public static final ArmorMaterial CAST_STEEL_MATERIAL = new ArmorMaterial(35, Util.make(new EnumMap<>(EquipmentType.class), map -> {
        map.put(EquipmentType.HELMET, 4);
        map.put(EquipmentType.CHESTPLATE, 9);
        map.put(EquipmentType.LEGGINGS, 7);
        map.put(EquipmentType.BOOTS, 4);
    ...
    public static final ArmorMaterial METEORIC_IRON_MATERIAL = new ArmorMaterial(38, Util.make(new EnumMap<>(EquipmentType.class), map -> {
        map.put(EquipmentType.HELMET, 4);
        map.put(EquipmentType.CHESTPLATE, 9);
        map.put(EquipmentType.LEGGINGS, 7);
        map.put(EquipmentType.BOOTS, 4);
        map.put(EquipmentType.BODY, 12);
    }), 15, SoundEvents.ITEM_ARMOR_EQUIP_DIAMOND, 5.5f, 0.7f, ModTags.Items.METEORIC_IRON_REPAIR, METEORIC_IRON_KEY);
}